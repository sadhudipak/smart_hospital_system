    ...
    <div class="bg-white rounded-xl shadow-sm p-8">
        ...
        <div class="flex justify-between items-start mb-8">
            <div>
                ...
                <p class="text-gray-600">Prescription for {{ $prescription->appointment->patient->name }}</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-gray-50 rounded-lg p-6">
                ...
                <div class="space-y-2">
                    <p class="font-medium text-gray-800">{{ $prescription->appointment->patient->name }}</p>
                    <p class="text-sm text-gray-600">{{ $prescription->appointment->patient->email }}</p>
                    @if($prescription->appointment->patient->phone)
                        <p class="text-sm text-gray-600">{{ $prescription->appointment->patient->phone }}</p>
                    @endif
                    @if($prescription->appointment->patient->date_of_birth)
                        <p class="text-sm text-gray-600">DOB: {{ $prescription->appointment->patient->date_of_birth->format('M d, Y') }}</p>
                    @endif
                </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-lg p-6">
                ...
                <div class="space-y-2">
                    <p class="font-medium text-gray-800">Dr. {{ $prescription->appointment->doctor->name }}</p>
                    <p class="text-sm text-gray-600">{{ $prescription->appointment->doctor->specialization }}</p>
                    <p class="text-sm text-gray-600">{{ $prescription->appointment->doctor->license_number }}</p>
                </div>
            </div>
        </div>
