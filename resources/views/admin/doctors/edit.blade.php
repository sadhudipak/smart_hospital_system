...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                ...
                <p class="text-gray-600 mt-2">Update doctor profile information</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-8">
        ...
        <form action="{{ route('admin.doctors.update', $doctor) }}" method="POST" class="space-y-6">
            ...
            <div class="border-b border-gray-200 pb-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="tel" id="phone" name="phone" value="{{ old('phone', $doctor->user->phone) }}"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
            ...
            <div class="border-b border-gray-200 pb-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="experience_years" name="experience_years" value="{{ old('experience_years', $doctor->experience_years) }}" required min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>

                    <div>
                        <label for="consultation_fee" class="block text-sm font-medium text-gray-700 mb-2">Consultation Fee (₹) *</label>
                        <input type="number" id="consultation_fee" name="consultation_fee" value="{{ old('consultation_fee', $doctor->consultation_fee) }}" required min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea id="bio" name="bio" rows="4" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 resize-none" placeholder="Brief professional bio...">{{ old('bio', $doctor->bio) }}</textarea>
                </div>
            </div>
            ...
            <div class="border-b border-gray-200 pb-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="time" id="available_from" name="available_from" value="{{ old('available_from', $doctor->available_from) }}" required
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>

                    <div>
                        <label for="available_to" class="block text-sm font-medium text-gray-700 mb-2">Available To *</label>
                        <input type="time" id="available_to" name="available_to" value="{{ old('available_to', $doctor->available_to) }}" required
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        @php
                            ...
                            $selectedDays = old('available_days', $doctor->available_days ?? []);
                        @endphp
                        @foreach($days as $day)
            ...
            <div>
                <label class="flex items-center">
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', $doctor->user->is_active) ? 'checked' : '' }}
                           class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                <a href="{{ route('admin.doctors.show', $doctor) }}" class="bg-gray-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-700 smooth-transition">
                    Cancel
                </a>
