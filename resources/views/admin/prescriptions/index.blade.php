...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h2 class="text-2xl font-bold text-gray-800 mb-2">Prescription Management</h2>
            <p class="text-gray-600">View and manage all prescriptions in the system</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-800">{{ $prescriptions->total() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-800">{{ $prescriptions->pluck('doctor.user.name')->unique()->count() }}</p>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <div class="text-sm text-gray-500">{{ $prescription->patient->email }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900">Dr. {{ $prescription->doctor->user->name }}</div>
                                            <div class="text-sm text-gray-500">{{ $prescription->doctor->specialization }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
